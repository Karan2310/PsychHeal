# Generated by Django 3.1.6 on 2022-02-12 05:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hobbies', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), blank=True, max_length=25, null=True, size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='TOKEN', to='PsychHealapp.signup')),
            ],
            options={
                'db_table': 'tokens',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PASSWORD', to='PsychHealapp.signup')),
            ],
            options={
                'db_table': 'passwords',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='RESETS', to='PsychHealapp.signup')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='PsychHealapp.signup')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ATTEMPTS', to='PsychHealapp.signup')),
            ],
            options={
                'db_table': 'login_logs',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hobbies', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='HOBBIES', to='PsychHealapp.signup')),
            ],
            options={
                'db_table': 'hobbies',
            },
